...
Add-Content -Path $clauseFile -Value "# Claude Context Export`n# Generated: $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')`n# Repo: gratitude`n"
...
Add-Content -Path $websiteFile -Value "# Website Context Export`n# Generated: $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')`n# Repo: gratitude`n"
...
Add-Content -Path $miscFile -Value "# Miscellaneous Context Export`n# Generated: $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')`n# Repo: gratitude`n"
